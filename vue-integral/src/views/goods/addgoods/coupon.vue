  ...
  <div class="main">
    <div class="page-title">
      <h2 class="has-sub-title"> 添加商品
        ...
        <span class="sub-title">添加优惠券</span>
      </h2>
    </div>
    <div class="page-content edit-goods-form">
      ...
      <div class="form-groups-chunk"><h4>兑换规则：</h4>
        ...
        <div class="form-group">
          ...
          <v-switch v-model="auditing"></v-switch>
          <p class="switch-tip">
        ...
        <div class="form-group">
          ...
          <div class="exchange-limit mt20" v-if="secKill">
            <div class="form-group time-limit">
              ...
              <v-selection :selections="staringTimeH"></v-selection>
              <span class="select-split">:</span>
              <v-selection :selections="startingTimeS"></v-selection>
              <span class="select-split">至</span>
              <v-selection :selections="endingTimeH"></v-selection>
              <span class="select-split">:</span>
              <v-selection :selections="endingTimeS"></v-selection>
              <p class="invalid" v-if="isShowWraing"><i class="iconfont">&#xe770;</i> 结束时间必须大于开始时间 </p>
              <div class="time-setting-tip">
                <p class="form-group-tip">
                  <span style="color:red">注：</span>
                  1.设置的开始时间，必须与当前的自然时间间隔在20 分钟以上，否则无法保存提交。
                </p>
                <p class="form-group-tip tip2-time">
                  2.当前时间距离上次设置秒杀商品的开始时间只剩 20 分钟时,不支持再修改时间。
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="form-groups-chunk">
        ...
        <div class="form-group pl20">
          <label class="label-style">编辑商品标签：</label>
          <input type="text" class="form-control newcount valid untouched pristine" placeholder="商品标签最多200个字符长度">
        </div>
      </div>
      <div class="form-group mt20">
        <a href="javascript:void(0)" class="btn btn-green btn-lg mr20">保存并导入券码</a>
      </div>
    </div>
  </div>
</template>
  ...
  export default{
    data() {
      return {
        ...
        staringTimeH: [{label: '时', vlaue: '时'}],         // 秒杀商品起始 时
        endingTimeH: [{label: '时', vlaue: '时'}],          // 秒杀商品起始 分
        startingTimeS: [{label: '分', vlaue: '分'}],        // 秒杀商品结束 时
        endingTimeS: [{label: '分', vlaue: '分'}],          // 秒杀商品起结束 分
        isShowWraing: false,                                // 警告（结束时间必须大于开始时间）
        colorIsShow:false,                                  // 颜色选择
        colors: {
          hex: '#D0021B',
          tone: 'D0021B',
          hsl: {
