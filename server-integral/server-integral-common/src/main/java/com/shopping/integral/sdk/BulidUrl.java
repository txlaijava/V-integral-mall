...
import com.shopping.integral.sdk.entity.CreditAuditParams;
import com.shopping.integral.sdk.entity.CreditConfirmParams;
import com.shopping.integral.sdk.entity.ExpressInfo;
...
public class BulidUrl {
	 ...
	 static String AppKey = "AppKey";  //此处填写开发者自己的appKey
	 static String AppSecret = "AppSecret"; //此处填写开发者自己的appSecret
	/**
	 *  构建在兑吧商城自动登录的url地址
	 * @param uid 用户id
